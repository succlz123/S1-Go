...
public class S1UrlHelper {
    ...
    public static final String SET_REVIEWS_GET="http://bbs.saraba1st.com/2b/api/mobile/index.php?mobile=no&version=1&module=secure&type=post";
    public static final String SET_REVIEWS_POST="http://bbs.saraba1st.com/2b/api/mobile/index.php?mobile=no&version=1&module=sendreply&replysubmit=yes&tid=";
