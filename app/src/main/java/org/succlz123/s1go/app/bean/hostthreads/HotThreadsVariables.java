 ...
 */
public class HotThreadsVariables {
    ...
    private List<HotThreadsDate> data;
    ...
    public List<HotThreadsDate> getHotPostDateList() {
        return data;
    }

    public void setHotPostDateList(List<HotThreadsDate> hotThreadsDateList) {
        this.data = hotThreadsDateList;
    }
}
