package org.succlz123.s1go.app.bean.reviews;
...
public class ThreadInfo {
    ...
    private String digest;//回复数
    private String displayorder;
    private String favtimes;
    private String fid;//板块名
    ...
    private String maxposition;//最大楼数   楼主帖+回复   默认回复+1
    ...
    private String typeid;//帖子typeid
